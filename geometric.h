...
struct sizes
{
  ...
  static int activeOperation; //1=selection  2=text 3=pen 4=fill 5=nothing  6=picker 7=line 8=shape 9=curve
...
// selection geometry
  ...
  static bool keepSelAspectRatio;
  static bool dotLines;
  static QList<int> customShapesCoord;
  static bool shapeToCurve;
  static bool lineAngleIndicator;
  static bool roundAngle;
  static bool lineRound;
