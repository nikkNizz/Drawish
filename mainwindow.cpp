    ...
    , ui(new Ui::MainWindow)
{
    ui->setupUi(this);
    version_info = "2.8";
    // 2.8: initial w h for shapes; add eraser; style label line; [curvelinearea.cpp]
    // differential redo; better tracer colors; icons in menu; added quick print
    // arrowhead length ; semitrasp in lines ; bug in tooltip (dcolors) ; added button count colors
    // changed menu install. ; split hor e vert; on load active pen; menu new window
    // erase except the active color; transpose image to color; lighten and darken
