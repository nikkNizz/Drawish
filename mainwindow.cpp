...
// 3.1  bug position pixel in zoom-matrix;  change the shape fill style immediately; anti-aliasing default
// anti-alias shapes
...
void MainWindow::get_color()
{
    ...
    sizes::activeColor = QColor::fromRgba(img.pixel(sizes::selX / sizes::zoomLevel, sizes::selY / sizes::zoomLevel));
    ui->colorActiveButton->setStyleSheet("background-color:" + sizes::activeColor.name());
    ui->rgbLabel->setText("Rgb " + QString::number(sizes::activeColor.red()) + " " + QString::number(sizes::activeColor.green())+ " " + QString::number(sizes::activeColor.blue()));
    }
    }
...
void MainWindow::createShapeArea()
{
    ...
    shape_area = new shapeArea(wArea, sizes::zoomLevel);
...
void MainWindow::draw_shape()
{
    ...
    if(sizes::activeOperation == 8 && sizes::isShapeOn ==false){
        ...
        QString tx = "left: " + QString::number(sizes::selX+3) + "px; top: " + QString::number(sizes::selY+1);
...
void MainWindow::zoomAll(double zm)
{
    ...
    if( preZoom != sizes::zoomLevel){
        ...
        if(sizes::isShapeOn){
            ...
            shape_area->Zoom = sizes::zoomLevel;
            shape_area->resetGeometry(true);
        }
